...
export default function SuccessStories() {
  return (
    <main className="bg-white relative overflow-hidden flex flex-col">
      ...
      {/* Hero Section */}
      <section className="relative min-h-[95vh]    w-full bg-[url('/hero-bg.webp')] bg-cover bg-center">
        <div className="mx-auto grid min-h-screen max-w-7xl grid-cols-1 px-6 pt-24 pb-12 lg:grid-cols-2 lg:items-center lg:px-8 lg:py-0">
          
          {/* Left Content */}
          <div className="flex flex-col items-start z-10 lg:pr-8 order-2 lg:order-1">
            {/* Badge */}
            <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-gray-100 bg-white px-4 py-2 shadow-sm sm:mb-8 sm:px-5 sm:py-2.5">
              ...
              <span className="text-xs sm:text-sm font-bold text-[#FF70A3] uppercase tracking-wide">Inspiring Gallery</span>
            </div>
            ...
            {/* CTA */}
            <button className="mt-8 mb-8 sm:mt-10 inline-flex w-full sm:w-auto justify-center items-center gap-3 rounded-2xl bg-[#FF70A3] px-8 py-4 text-base sm:text-lg font-bold text-white shadow-lg transition hover:bg-rose-500 hover:scale-105 active:scale-95">
              Book A Consultation
          ...
          {/* Right Image */}
          <div className="relative h-[400px] w-full sm:h-[500px] lg:h-screen lg:absolute lg:right-0 lg:top-0 lg:w-1/2 order-1 lg:order-2 mb-8 lg:mb-0">
            <Image
              src="/doctor.webp"
              alt="Dr. Chaithra"
              fill
